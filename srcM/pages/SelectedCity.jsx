...
function SelectedCity({ list }) {
  ...
  return (
    <>
      ...
      <FoodCate selectedCityData={selectedCityData}></FoodCate>
      <ExperienceCate selectedCityData={selectedCityData}></ExperienceCate>
      <HotelCate selectedCityData={selectedCityData}></HotelCate>
    </>
  );
}
